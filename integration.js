...
function stepLoanDetails(){
  ...
  <div class="field"><label>Current Address<span class="req">*</span></label><textarea id="apAddress" rows="2">${escapeHtml(d.personal.address)}</textarea><div class="error hidden" id="err_apAddress"></div></div>
...
function stepEmployment(){
  ...
  <div class="field"><label>CIBIL Score<span class="req">*</span></label><input type="number" id="apCibil" min="300" max="900" value="${e.cibil}"><div class="error hidden" id="err_apCibil"></div></div>
  <div style="display:flex;justify-content:space-between;margin-top:16px;">
