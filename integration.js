...
function tplRegister(){
  ...
  return `
    ...
    <div class="two-col">
      <div class="field"><label>Identity Document<span class="req">*</span></label>
        <select id="regIdType"><option value="Aadhaar">Aadhaar</option><option value="PAN">PAN</option></select>
      </div>
      <div class="field"><label>ID Number<span class="req">*</span></label><input id="regIdNumber" placeholder="e.g. ABCDE1234F"><div class="error hidden" id="err_regIdNumber"></div></div>
    </div>
    <div class="two-col">
      <div class="field">
        <label>Password<span class="req">*</span></label>
